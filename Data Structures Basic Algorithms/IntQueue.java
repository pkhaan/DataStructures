...
public interface IntQueue<T> {
	...
	/**
	 * print the elements of the queue, starting from the oldest item, to the print
	 * stream given as argument. For example, to print the elements to the standard
	 * output, pass System.out as parameter. E.g., printQueue(System.out);
	 */
